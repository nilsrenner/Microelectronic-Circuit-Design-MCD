...
N 820 110 880 110 {lab=VOUT_INV}
N 880 110 880 200 {lab=VOUT_INV}
...
N 810 200 810 220 {lab=VOUT_INV}
...
N 880 200 970 200 {lab=VOUT_INV}
N 810 200 880 200 {lab=VOUT_INV}
N 450 -110 990 -110 {lab=VOUT_LP}
N 970 0 970 200 {lab=VOUT_INV}
...
C {param.sym} -180 -290 0 0 {name=s1 value="C_LP=1.06e-6"}
C {param.sym} -180 -260 0 0 {name=s2 value="R_LP=1000"}
...
C {param.sym} 80 -290 0 0 {name=s3 value="C_HP=1e-9"}
C {param.sym} 80 -260 0 0 {name=s4 value="R_HP=1.06e6"}
...
C {opin.sym} 970 200 0 0 {name=p4 lab=VOUT_INV}
