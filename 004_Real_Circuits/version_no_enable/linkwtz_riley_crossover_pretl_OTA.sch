...
C {/foss/designs/real_circuit/ota-5t_no_ena_copy.sym} -120 -130 0 0 {name=x1}
C {/foss/designs/real_circuit/ota-5t_no_ena_copy.sym} -130 220 0 0 {name=x2}
