...
F {}
E {}
N -240 -20 -160 -20 {lab=vt}
N -160 -20 -160 10 {lab=vt}
N -160 -20 -60 -20 {lab=vt}
N -380 40 -200 40 {lab=ibias}
...
N -240 -80 -240 -20 {lab=vt}
N -60 -80 -60 -20 {lab=vt}
N -60 -240 -50 -240 {lab=vdd}
N -250 -280 -250 -270 {lab=vdd}
...
N -260 -280 -250 -280 {lab=vdd}
N -250 -300 -250 -280 {lab=vdd}
N -250 -210 -250 -190 {lab=vb}
N -250 -300 -60 -300 {lab=vdd}
N -250 -90 -250 -80 {lab=vt}
N -250 -80 -240 -80 {lab=vt}
N -240 -120 -240 -80 {lab=vt}
N -70 -80 -60 -80 {lab=vt}
N -60 -90 -60 -80 {lab=vt}
N -60 -280 -60 -270 {lab=vdd}
N -50 -280 -50 -240 {lab=vdd}
