...
foreach ti -40 -20 0 20 40 60 80 100 120 140
    ...
    * vtest=1, itest=0:
    ...
    wrdata out_ac_$\{ti\}.txt v_out
end

plot db(ac1.ttian) db(ac2.ttian) db(ac3.ttian) db(ac4.ttian) db(ac5.ttian) db(ac6.ttian) db(ac7.ttian) db(ac8.ttian) db(ac9.ttian) ylabel 'Magnitude - Tian'

plot 180/pi*cphase(ac1.ttian) 180/pi*cphase(ac2.ttian) 180/pi*cphase(ac3.ttian) 180/pi*cphase(ac4.ttian) 180/pi*cphase(ac5.ttian) 180/pi*cphase(ac6.ttian) 180/pi*cphase(ac7.ttian) 180/pi*cphase(ac8.ttian) 180/pi*cphase(ac9.ttian) ylabel 'Phase - Tian'
...
C {devices/isource.sym} 1380 -530 0 0 {name=I1 value=30u pwl(0 0 10u 0 11u 20u)"}
...
C {devices/isource.sym} 2140 -530 0 0 {name=I2 value=30u pwl(0 0 10u 0 11u 20u)"}
...
C {devices/isource.sym} 1380 -1090 0 0 {name=I3 value=30u pwl(0 0 10u 0 11u 20u)"}
...
C {devices/isource.sym} 2140 -1090 0 0 {name=I4 value=30u pwl(0 0 10u 0 11u 20u)"}
...
C {003_version_second_output_stage/ota-5t_no_ena_copy.sym} 1350 -960 0 0 {name=x1}
C {003_version_second_output_stage/ota-5t_no_ena_copy.sym} 2110 -960 0 0 {name=x2}
C {003_version_second_output_stage/ota-5t_no_ena_copy.sym} 1350 -400 0 0 {name=x3}
C {003_version_second_output_stage/ota-5t_no_ena_copy.sym} 2110 -400 0 0 {name=x4}
