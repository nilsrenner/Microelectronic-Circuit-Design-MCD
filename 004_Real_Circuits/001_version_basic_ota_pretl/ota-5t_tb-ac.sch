...
N 1090 -550 1090 -520 {lab=v_ena}
N 800 -250 800 -230 {lab=v_ss}
N 800 -330 800 -310 {lab=v_ena}
...
C {devices/vsource.sym} 800 -280 0 0 {name=Venable value=1.5 savecurrent=false}
C {devices/lab_wire.sym} 800 -330 0 1 {name=p8 sig_type=std_logic lab=v_ena}
C {devices/lab_pin.sym} 800 -230 0 0 {name=p12 sig_type=std_logic lab=v_ss}
C {devices/lab_wire.sym} 1090 -520 0 1 {name=p7 sig_type=std_logic lab=v_ena}
